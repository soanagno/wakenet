...
if synth == 1:
    ...
    xs = np.array([0, 0, 0, 7*D, 7*D, 7*D, 14*D, 14*D, 14*D, 21*D, 21*D, 21*D, 28*D, 28*D, 28*D, 35*D, 35*D, 35*D, 42*D, 42*D, 42*D, 49*D, 49*D, 49*D, 56*D])
    ys = np.array([0*D, 2*D, 4*D, 1*D, 3*D, 5*D, 0*D, 2*D, 4*D, 1*D, 3*D, 5*D, 0*D, 2*D, 4*D, 1*D, 3*D, 5*D, 0*D, 2*D, 4*D, 1*D, 3*D, 5*D, 0*D])
    ...
    for i in range(max_turbines):
        ...
        for _ in range(iterations):
            floris_time, neural_time = Compare(yws=yws[:i+1], ws=7, ti=0.05, xs=xs[:i+1], ys=ys[:i+1], print_times=False, timings=True)
